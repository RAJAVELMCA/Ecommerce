...
def otpVerify(request):
	...
	if otp == None:
		...
		return render(request,'ecom/otpform.html')
	else:
		if request.method == "POST":
...
def upi(request):
    return render(request,'ecom/upi.html')
def wallet(request):
    return render(request,'ecom/wallet.html')
def cod(request):
    return render(request,'ecom/cod.html')
def banking(request):
    return render(request,'ecom/banking.html')
def emi(request):
    return render(request,'ecom/credict.html')
def debit(request):
    return render(request,'ecom/debit.html')
...
def customer_address_view(request):
    ...
    if request.method == 'POST':
        ...
        if addressForm.is_valid():
            ...
            response = render(request, 'ecom/pay.html',{'total':total})
...
def payment_success_view(request):
    ...
    outlook.send(
        ...
        text = """\
                ...
                Thaks for visiting Us.....!
                To continue shopping and enjoy Us....! 


                    \
                """.format(customer.user.username))
...
def index1(request):
    return render(request,'ecom/index1.html')

def about(request):
    return render(request,'ecom/about.html')   

def service(request):
    return render(request,'ecom/service.html')        
